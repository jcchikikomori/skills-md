---
name: frontend
description: Frontend development guidance covering React, Vue, modern CSS, accessibility, TypeScript, state management, and performance. Use when building or reviewing frontend UI code.
---
