---
name: docker
description: Docker and Docker Compose best practices, multi-stage builds, container security, and performance. Use when writing or reviewing Dockerfiles or compose configs.
---
