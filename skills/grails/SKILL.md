---
name: grails
description: Web application development using the Grails framework (Groovy), covering GORM, MVC conventions, Groovy syntax, and service layers. Use when writing or reviewing Grails code.
---
