---
name: web-audit
description: Audits web applications for browser compatibility and security vulnerabilities following OWASP API Security Top 10. Use when running a web app audit.
---
