---
name: debug
description: Debugs production issues by reproducing bugs, running 5 Whys root cause analysis, and writing verifying test cases. Use when investigating a bug or production incident.
---
