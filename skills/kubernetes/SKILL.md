---
name: kubernetes
description: Kubernetes best practices, translating Docker concepts to K8s, writing manifests (Deployments, Services), and using kubectl. Use when writing or reviewing K8s manifests or commands.
---
