---
name: spring-boot
description: Java/Kotlin backend development using Spring Boot, covering Controller-Service-Repository patterns, Spring Data JPA, Spring Security, and dependency injection. Use when writing or reviewing Spring Boot code.
---
