---
name: backend
description: Backend development best practices for APIs, database design, security, architecture, and performance across Python, Node.js, Ruby, and other server-side stacks. Use when designing or reviewing backend code.
---
