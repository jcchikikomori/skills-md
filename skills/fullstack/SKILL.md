---
name: fullstack
description: Full-stack development combining frontend and backend—data fetching, authentication, monorepo patterns, DevOps awareness, and end-to-end security. Use when a change spans both layers.
---
